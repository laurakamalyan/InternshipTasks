...
$app->singleton(
    App\Http\Contracts\PositionRepositoryInterface::class,
    App\Http\Repositories\PositionRepository::class,
);
...
$app->singleton(
    App\Http\Contracts\EmployeeRepositoryInterface::class,
    App\Http\Repositories\EmployeeRepository::class,
);
